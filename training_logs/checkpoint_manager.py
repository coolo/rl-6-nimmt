...
class CheckpointManager:
    ...
    def create_checkpoint(
        self, players: List["Take6Player"], cycle: int, save_top_n: int = 10, save_all: bool = False, tournament_results: Optional[Dict] = None
    ) -> str:
        ...
        self.logger.info(f"Created checkpoint {checkpoint_name}: " f"top player {best_player.player_id} (ELO: {best_player.elo_rating:.1f})")
    ...
    def create_final_checkpoint(self, players: List["Take6Player"], tournament_results: Optional[Dict] = None) -> str:
